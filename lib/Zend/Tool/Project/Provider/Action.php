    ...
    implements Zend_Tool_Framework_Provider_Pretendable
{
    ...
    public static function hasResource(Zend_Tool_Project_Profile $profile, $actionName, $controllerName, $moduleName = null)
    {
        ...
        if ($controllerFile == null) {
            throw new Zend_Tool_Project_Provider_Exception('Controllers ' . $controllerName . ' was not found.');
        }
     ...
     * @param string $controllerName Controllers name action should be applied to.
