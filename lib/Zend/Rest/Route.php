 ...
 */
#require_once 'Zend/Controllers/Router/Route/Interface.php';

/**
 * @see Zend_Controller_Router_Route_Module
 */
#require_once 'Zend/Controllers/Router/Route/Module.php';

/**
 * @see Zend_Controller_Dispatcher_Interface
 */
#require_once 'Zend/Controllers/Dispatcher/Interface.php';

/**
 * @see Zend_Controller_Request_Abstract
 */
#require_once 'Zend/Controllers/Request/Abstract.php';
...
class Zend_Rest_Route extends Zend_Controller_Router_Route_Module
{
     ...
     * Constructor
     *
     * @param Zend_Controller_Front $front Front Controllers object
        ...
        if ($path != '') {
            ...
            if (count($path) && !empty($path[0])) {
                if ($this->_checkRestfulController($moduleName, $path[0])) {
                    ...
                    // If Controllers in URI is not found to be a RESTful
                    // Controllers, return false to fall back to other routes
                    return false;
                }
