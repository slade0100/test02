 ...
 */
#require_once 'Zend/Controllers/Response/Abstract.php';
...
interface Zend_Controller_Dispatcher_Interface
{
    ...
    /**
     * Add or modify a parameter with which to instantiate an Action Controllers
     *
     * @param string $name
     * @param mixed $value
    ...
    /**
     * Set an array of a parameters to pass to the Action Controllers constructor
     *
     * @param array $params
     * @return Zend_Controller_Dispatcher_Interface
     */
    ...
    /**
     * Retrieve the parameters to pass to the Action Controllers constructor
     *
     * @return array
     */
