...
#require_once 'Zend/Controllers/Dispatcher/Abstract.php';
...
class Zend_Controller_Dispatcher_Standard extends Zend_Controller_Dispatcher_Abstract
{
    ...
    public function setControllerDirectory($directory, $module = null)
    {
        ...
        if (is_string($directory)) {
            ...
            throw new Zend_Controller_Exception('Controllers directory spec must be either a string or an array');
        }
    ...
    public function dispatch(Zend_Controller_Request_Abstract $request, Zend_Controller_Response_Abstract $response)
    {
        ...
        if (!$this->isDispatchable($request)) {
            ...
            if (!$this->getParam('useDefaultControllerAlways') && !empty($controller)) {
                #require_once 'Zend/Controllers/Dispatcher/Exception.php';
        ...
        if (!($controller instanceof Zend_Controller_Action_Interface) &&
            ...
            throw new Zend_Controller_Dispatcher_Exception(
                'Controllers "' . $className . '" is not an instance of Zend_Controller_Action_Interface'
            );
        }
