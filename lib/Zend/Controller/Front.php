...
#require_once 'Zend/Controllers/Action/HelperBroker.php';

/** Zend_Controller_Plugin_Broker */
#require_once 'Zend/Controllers/Plugin/Broker.php';
...
class Zend_Controller_Front
{
    ...
    public function addModuleDirectory($path)
    {
        try{
            ...
            #require_once 'Zend/Controllers/Exception.php';
    ...
    public function getRouter()
    {
        if (null == $this->_router) {
            #require_once 'Zend/Controllers/Router/Rewrite.php';
    ...
    public function getDispatcher()
    {
        ...
        if (!$this->_dispatcher instanceof Zend_Controller_Dispatcher_Interface) {
            #require_once 'Zend/Controllers/Dispatcher/Standard.php';
    ...
    public function dispatch(Zend_Controller_Request_Abstract $request = null, Zend_Controller_Response_Abstract $response = null)
    {
        if (!$this->getParam('noErrorHandler') && !$this->_plugins->hasPlugin('Zend_Controller_Plugin_ErrorHandler')) {
            ...
            #require_once 'Zend/Controllers/Plugin/ErrorHandler.php';
            $this->_plugins->registerPlugin(new Zend_Controller_Plugin_ErrorHandler(), 100);
        }

        if (!$this->getParam('noViewRenderer') && !Zend_Controller_Action_HelperBroker::hasHelper('viewRenderer')) {
            #require_once 'Zend/Controllers/Action/Helper/ViewRenderer.php';
        ...
        if (null !== $request) {
            ...
            #require_once 'Zend/Controllers/Request/Http.php';
        ...
        if (null !== $response) {
            ...
            #require_once 'Zend/Controllers/Response/Http.php';
