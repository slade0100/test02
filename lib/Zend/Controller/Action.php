 ...
 */
#require_once 'Zend/Controllers/Action/Interface.php';

/**
 * @see Zend_Controller_Front
 */
#require_once 'Zend/Controllers/Front.php';
...
abstract class Zend_Controller_Action implements Zend_Controller_Action_Interface
{
    ...
    {
        #require_once 'Zend/Controllers/Action/Exception.php';
     ...
     *
     * Not used in the Action controllers implementation, but left for usage in
     * Page controllers implementations. Dispatches a method based on the
     * request.
     *
